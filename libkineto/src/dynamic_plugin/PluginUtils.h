...
static inline KinetoPlugin_ProfileEventType
convertFromActivityType(ActivityType type) {
  switch (type) {
...
static inline std::vector<KinetoPlugin_ProfileEventType>
convertActivityTypeSet(const std::set<ActivityType> &activityTypes) {
