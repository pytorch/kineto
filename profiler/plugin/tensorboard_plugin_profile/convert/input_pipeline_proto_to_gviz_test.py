...
class ProtoToGvizTest(unittest.TestCase):
  ...
  def create_mock_input_pipeline(self):
    ...
    for _ in range(0, 3):
      ...
      step_details_list.append(step_details_any)
    ipa.step_details.extend(step_details_list)
    ...
    for _ in range(0, 3):
      ...
      input_op_details_list.append(input_op_details)
    ipa.input_op_details.extend(input_op_details_list)
  ...
  def test_input_pipeline_step_breakdown(self):
    ...
    self.assertEqual(len(table_description), 10)
