...
public:
  ...
  static int toolInit(rocprofiler_client_finalize_t finalize_func,
                      void *tool_data);
  static void toolFinialize(void *tool_data);

  static std::string opString(rocprofiler_callback_tracing_kind_t kind,
                              rocprofiler_tracing_operation_t op);

  static std::string opString(rocprofiler_buffer_tracing_kind_t kind,
                              rocprofiler_tracing_operation_t op);
